...
from src.task import (
    ...
    set_cookie as task_set_cookie,
    config_selected_album,
    download_selected_album as task_download_selected_album,
    empty_download_record as task_empty_download_record,
    select_and_download_single_album,
    exit_syncer,
    refresh_cookie as task_refresh_cookie,
)
