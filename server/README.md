...
```shell
SQLITE_URL='jdbc:sqlite:/app/db/xiaomialbumsyncer.db?journal_mode=WAL&synchronous=NORMAL&cache_size=10000&temp_store=memory&mmap_size=0&busy_timeout=5000'
```
