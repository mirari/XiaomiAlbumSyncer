      ...
      <div class="flex gap-8 items-start">
        <div class="flex-1 space-y-4 min-w-0">
            ...
            <div class="space-y-2">
              <div class="flex items-center justify-between">
                ...
                <Button
                  ...
                  @click="
                    () => {
                      showCronHelp = !showCronHelp
                      if (showCronHelp) showExpressionHelp = false
                    }
                  "
                />
              </div>
          ...
          <div class="space-y-2">
            ...
            <InputText
              v-model="cronForm.config.targetPath"
          ...
          <div class="space-y-2">
            <div class="flex items-center justify-between">
              ...
              <Button
                ...
                @click="
                  () => {
                    showExpressionHelp = !showExpressionHelp
                    if (showExpressionHelp) showCronHelp = false
                  }
                "
              />
            </div>
            <InputText
              v-model="cronForm.config.expressionTargetPath"
          ...
          <Message severity="info" variant="simple" icon="pi pi-info-circle">
            <div class="text-[12px]">
              ...
              ><span class="font-semibold">相互独立</span>，<span class="font-semibold"
                >互不影响</span
