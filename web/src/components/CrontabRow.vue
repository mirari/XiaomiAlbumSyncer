...
const enabledOptionTags = computed(() => {
  ...
  if (props.crontab.syncMode === 'CURSOR') tags.push(t('schedule.options.syncByCursor'))
  else if (props.crontab.syncMode === 'TIMELINE') tags.push(t('schedule.options.diffByTimeline'))
